...
namespace Renaissance.Protocol.types.game.actions.fight
{
	public class FightTemporaryBoostEffect : AbstractFightDispellableEffect, IDofusType
	{
		...
		public FightTemporaryBoostEffect InitFightTemporaryBoostEffect(CustomVar<int> _uid, double _targetid, short _turnduration, byte _dispelable, CustomVar<short> _spellid, CustomVar<int> _effectid, CustomVar<int> _parentboostuid, short _delta)
		{
