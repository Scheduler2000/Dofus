...
namespace Renaissance.Protocol.types.game.mount
{
	public class MountClientData : IDofusType
	{
		...
		public  Memory<byte> Serialize()
		{
			...
			size += DofusBinaryFactory.Sizing.SizeOf((short)(this.Ancestor.Length));
			size += DofusBinaryFactory.Sizing.SizeOf(Ancestor);
			size += DofusBinaryFactory.Sizing.SizeOf((short)(this.Behaviors.Length));
			size += DofusBinaryFactory.Sizing.SizeOf(Behaviors);
			...
			size += DofusBinaryFactory.Sizing.SizeOf(ExperienceForLevel);
			size += DofusBinaryFactory.Sizing.SizeOf(ExperienceForNextLevel);
			size += DofusBinaryFactory.Sizing.SizeOf(Level);
			size++;
			size += DofusBinaryFactory.Sizing.SizeOf(MaxPods);
			size++;
			size += DofusBinaryFactory.Sizing.SizeOf(Stamina);
			size += DofusBinaryFactory.Sizing.SizeOf(StaminaMax);
			size += DofusBinaryFactory.Sizing.SizeOf(Maturity);
			size += DofusBinaryFactory.Sizing.SizeOf(MaturityForAdult);
			size += DofusBinaryFactory.Sizing.SizeOf(Energy);
			size += DofusBinaryFactory.Sizing.SizeOf(EnergyMax);
			size += DofusBinaryFactory.Sizing.SizeOf(Serenity);
			size += DofusBinaryFactory.Sizing.SizeOf(AggressivityMax);
			size += DofusBinaryFactory.Sizing.SizeOf(SerenityMax);
			size += DofusBinaryFactory.Sizing.SizeOf(Love);
			size += DofusBinaryFactory.Sizing.SizeOf(LoveMax);
			size += DofusBinaryFactory.Sizing.SizeOf(FecondationTime);
			size++;
			size += DofusBinaryFactory.Sizing.SizeOf(BoostLimiter);
			size += DofusBinaryFactory.Sizing.SizeOf(BoostMax);
			size += DofusBinaryFactory.Sizing.SizeOf(ReproductionCount);
			size += DofusBinaryFactory.Sizing.SizeOf(ReproductionCountMax);
			size += DofusBinaryFactory.Sizing.SizeOf(HarnessGID);
			size++;
			size += DofusBinaryFactory.Sizing.SizeOf((short)(this.EffectList.Length));
			var memory1 = new Memory<byte>[EffectList.Length];
			for(int i = 0; i < EffectList.Length; i++)
			{
				memory1[i] = this.EffectList[i].Serialize();
			...
			writer.WriteData((short)(this.Ancestor.Length));
			writer.WriteDatas(Ancestor);
			writer.WriteData((short)(this.Behaviors.Length));
			writer.WriteDatas(Behaviors);
			writer.WriteData(this.Name);
			writer.WriteData(this.OwnerId);
			writer.WriteData(this.Experience);
			writer.WriteData(this.ExperienceForLevel);
			writer.WriteData(this.ExperienceForNextLevel);
			writer.WriteData(this.Level);
			writer.WriteData(this.MaxPods);
			writer.WriteData(this.Stamina);
			writer.WriteData(this.StaminaMax);
			writer.WriteData(this.Maturity);
			writer.WriteData(this.MaturityForAdult);
			writer.WriteData(this.Energy);
			writer.WriteData(this.EnergyMax);
			writer.WriteData(this.Serenity);
			writer.WriteData(this.AggressivityMax);
			writer.WriteData(this.SerenityMax);
			writer.WriteData(this.Love);
			writer.WriteData(this.LoveMax);
			writer.WriteData(this.FecondationTime);
			writer.WriteData(this.BoostLimiter);
			writer.WriteData(this.BoostMax);
			writer.WriteData(this.ReproductionCount);
			writer.WriteData(this.ReproductionCountMax);
			writer.WriteData(this.HarnessGID);
			writer.WriteData((short)(this.EffectList.Length));
