...
namespace Renaissance.Protocol.types.game.context.fight
{
	public class FightResultPlayerListEntry : FightResultFighterListEntry, IDofusType
	{
		...
		public FightResultPlayerListEntry InitFightResultPlayerListEntry(CustomVar<short> _level, FightResultAdditionalData[] _additional)
		{
		...
		public new byte[] Serialize()
		{
			...
			writer.Write((short)(this.Additional.Length));
