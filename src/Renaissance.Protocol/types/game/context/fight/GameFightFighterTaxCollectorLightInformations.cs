...
namespace Renaissance.Protocol.types.game.context.fight
{
	public class GameFightFighterTaxCollectorLightInformations : GameFightFighterLightInformations, IDofusType
	{
		...
		public GameFightFighterTaxCollectorLightInformations InitGameFightFighterTaxCollectorLightInformations(CustomVar<short> _firstnameid, CustomVar<short> _lastnameid)
		{
