...
{
	public class ObjectItemNotInContainer : Item, IDofusType
	{
		public new const int NetworkId = 134;
		...
		public ObjectItemNotInContainer InitObjectItemNotInContainer(CustomVar<short> _objectgid, ObjectEffect[] _effects, CustomVar<int> _objectuid, CustomVar<int> _quantity)
		{
