...
{
	public class ObjectItemToSellInHumanVendorShop : Item, IDofusType
	{
		public new const int NetworkId = 359;
		...
		public CustomVar<long> PublicPrice { get; set; }


		public ObjectItemToSellInHumanVendorShop() { }


		public ObjectItemToSellInHumanVendorShop InitObjectItemToSellInHumanVendorShop(CustomVar<short> _objectgid, ObjectEffect[] _effects, CustomVar<int> _objectuid, CustomVar<int> _quantity, CustomVar<long> _objectprice, CustomVar<long> _publicprice)
		{
		...
		public new Memory<byte> Serialize()
		{
			...
			size += DofusBinaryFactory.Sizing.SizeOf(PublicPrice);
			...
			writer.WriteData(this.PublicPrice);
		...
		public new void Deserialize(DofusReader reader)
		{
			...
			this.PublicPrice = reader.Read<CustomVar<long>>();
