...
{
	public class ObjectEffectString : ObjectEffect, IDofusType
	{
		public new const int NetworkId = 74;
		...
		public ObjectEffectString InitObjectEffectString(CustomVar<short> _actionid, string _value)
		{
