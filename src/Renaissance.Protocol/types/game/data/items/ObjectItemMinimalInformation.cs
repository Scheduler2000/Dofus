...
{
	public class ObjectItemMinimalInformation : Item, IDofusType
	{
		public new const int NetworkId = 124;
		...
		public ObjectItemMinimalInformation InitObjectItemMinimalInformation(CustomVar<short> _objectgid, ObjectEffect[] _effects)
		{
