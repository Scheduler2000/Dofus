...
namespace Renaissance.Protocol.messages.game.chat
{
	public class ChatServerCopyWithObjectMessage : ChatServerCopyMessage, IDofusMessage
	{
		...
		public ChatServerCopyWithObjectMessage InitChatServerCopyWithObjectMessage(CustomVar<long> _receiverid, string _receivername, byte _channel, string _content, int _timestamp, string _fingerprint, ObjectItem[] _objects)
		{

			base.ReceiverId = _receiverid;
			base.ReceiverName = _receivername;
