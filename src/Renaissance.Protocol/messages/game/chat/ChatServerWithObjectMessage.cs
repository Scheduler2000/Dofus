...
{
	public class ChatServerWithObjectMessage : ChatServerMessage, IDofusMessage
	{
		public new const int NetworkId = 883;
		...
		public ChatServerWithObjectMessage InitChatServerWithObjectMessage(double _senderid, string _sendername, string _prefix, int _senderaccountid, byte _channel, string _content, int _timestamp, string _fingerprint, ObjectItem[] _objects)
		{

			base.SenderId = _senderid;
			base.SenderName = _sendername;
			base.Prefix = _prefix;
			base.SenderAccountId = _senderaccountid;
