...
{
	public class ShortcutBarRemoveErrorMessage : IDofusMessage
	{
		public  const int NetworkId = 6222;
		...
		public ShortcutBarRemoveErrorMessage InitShortcutBarRemoveErrorMessage(byte _error)
		{
