...
{
	public class ExchangeObjectPutInBagMessage : ExchangeObjectMessage, IDofusMessage
	{
		public new const int NetworkId = 6009;
		...
		public ExchangeObjectPutInBagMessage InitExchangeObjectPutInBagMessage(bool _remote, ObjectItem _object)
		{
