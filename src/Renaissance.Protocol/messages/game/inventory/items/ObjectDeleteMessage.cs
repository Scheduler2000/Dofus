...
{
	public class ObjectDeleteMessage : IDofusMessage
	{
		public  const int NetworkId = 3022;
		...
		public ObjectDeleteMessage InitObjectDeleteMessage(CustomVar<int> _objectuid, CustomVar<int> _quantity)
		{
