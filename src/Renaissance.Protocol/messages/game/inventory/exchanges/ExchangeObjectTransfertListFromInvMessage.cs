...
{
	public class ExchangeObjectTransfertListFromInvMessage : IDofusMessage
	{
		public  const int NetworkId = 6183;
		...
		public ExchangeObjectTransfertListFromInvMessage InitExchangeObjectTransfertListFromInvMessage(CustomVar<int>[] _ids)
		{
