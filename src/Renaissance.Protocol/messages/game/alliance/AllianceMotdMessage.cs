...
{
	public class AllianceMotdMessage : SocialNoticeMessage, IDofusMessage
	{
		public new const int NetworkId = 6685;
		...
		public AllianceMotdMessage InitAllianceMotdMessage()
		{
