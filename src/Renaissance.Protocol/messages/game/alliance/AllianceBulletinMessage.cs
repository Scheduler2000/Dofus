...
{
	public class AllianceBulletinMessage : BulletinMessage, IDofusMessage
	{
		public new const int NetworkId = 6690;
		...
		public AllianceBulletinMessage InitAllianceBulletinMessage()
		{
