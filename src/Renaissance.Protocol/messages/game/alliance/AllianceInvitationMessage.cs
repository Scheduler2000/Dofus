...
{
	public class AllianceInvitationMessage : IDofusMessage
	{
		public  const int NetworkId = 6395;
		...
		public AllianceInvitationMessage InitAllianceInvitationMessage(CustomVar<long> _targetid)
		{
