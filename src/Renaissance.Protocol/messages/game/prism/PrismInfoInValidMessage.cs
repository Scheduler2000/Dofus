...
{
	public class PrismInfoInValidMessage : IDofusMessage
	{
		public  const int NetworkId = 5859;
		...
		public PrismInfoInValidMessage InitPrismInfoInValidMessage(byte _reason)
		{
