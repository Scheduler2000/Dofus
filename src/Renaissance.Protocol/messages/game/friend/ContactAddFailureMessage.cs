...
{
	public class ContactAddFailureMessage : IDofusMessage
	{
		public  const int NetworkId = 6821;
		...
		public ContactAddFailureMessage InitContactAddFailureMessage(byte _reason)
		{
