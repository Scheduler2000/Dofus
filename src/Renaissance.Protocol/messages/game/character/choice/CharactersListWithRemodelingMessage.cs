...
namespace Renaissance.Protocol.messages.game.character.choice
{
    public class CharactersListWithRemodelingMessage : CharactersListMessage, IDofusMessage
	{
		...
		public CharactersListWithRemodelingMessage InitCharactersListWithRemodelingMessage(CharacterToRemodelInformations[] _characterstoremodel)
		{
		...
		public new byte[] Serialize()
		{
			...
			writer.Write((short)(this.CharactersToRemodel.Length));
			foreach(var obj in CharactersToRemodel)
			{
