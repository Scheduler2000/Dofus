...
{
	public class GuildBulletinMessage : BulletinMessage, IDofusMessage
	{
		public new const int NetworkId = 6689;
		...
		public GuildBulletinMessage InitGuildBulletinMessage()
		{
