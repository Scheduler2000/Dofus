...
{
	public class TaxCollectorMovementMessage : IDofusMessage
	{
		public  const int NetworkId = 5633;
		...
		public TaxCollectorMovementMessage InitTaxCollectorMovementMessage(byte _movementtype, TaxCollectorBasicInformations _basicinfos, CustomVar<long> _playerid, string _playername)
		{
