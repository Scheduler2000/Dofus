...
{
	public class GameActionFightInvisibleDetectedMessage : AbstractGameActionMessage, IDofusMessage
	{
		public new const int NetworkId = 6320;
		...
		public GameActionFightInvisibleDetectedMessage InitGameActionFightInvisibleDetectedMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, short _cellid)
		{
