...
{
	public class GameActionFightTeleportOnSameMapMessage : AbstractGameActionMessage, IDofusMessage
	{
		public new const int NetworkId = 5528;
		...
		public GameActionFightTeleportOnSameMapMessage InitGameActionFightTeleportOnSameMapMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, short _cellid)
		{
