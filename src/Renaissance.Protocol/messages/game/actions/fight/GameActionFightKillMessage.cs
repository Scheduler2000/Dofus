...
{
	public class GameActionFightKillMessage : AbstractGameActionMessage, IDofusMessage
	{
		public new const int NetworkId = 5571;
		...
		public GameActionFightKillMessage InitGameActionFightKillMessage(CustomVar<short> _actionid, double _sourceid, double _targetid)
		{
