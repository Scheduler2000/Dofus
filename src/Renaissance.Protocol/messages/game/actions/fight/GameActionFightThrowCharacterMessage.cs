...
namespace Renaissance.Protocol.messages.game.actions.fight
{
	public class GameActionFightThrowCharacterMessage : AbstractGameActionMessage, IDofusMessage
	{
		...
		public GameActionFightThrowCharacterMessage InitGameActionFightThrowCharacterMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, short _cellid)
		{
