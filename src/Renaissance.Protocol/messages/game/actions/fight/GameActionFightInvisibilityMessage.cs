...
namespace Renaissance.Protocol.messages.game.actions.fight
{
	public class GameActionFightInvisibilityMessage : AbstractGameActionMessage, IDofusMessage
	{
		...
		public GameActionFightInvisibilityMessage InitGameActionFightInvisibilityMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, byte _state)
		{
