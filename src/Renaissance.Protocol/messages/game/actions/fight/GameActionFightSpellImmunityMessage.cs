...
namespace Renaissance.Protocol.messages.game.actions.fight
{
	public class GameActionFightSpellImmunityMessage : AbstractGameActionMessage, IDofusMessage
	{
		...
		public GameActionFightSpellImmunityMessage InitGameActionFightSpellImmunityMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, CustomVar<short> _spellid)
		{
