...
{
	public class GameActionFightLifePointsGainMessage : AbstractGameActionMessage, IDofusMessage
	{
		public new const int NetworkId = 6311;
		public new int ProtocolId { get { return NetworkId; } }

		public double TargetId { get; set; }

		public CustomVar<int> Delta { get; set; }


		public GameActionFightLifePointsGainMessage() { }


		public GameActionFightLifePointsGainMessage InitGameActionFightLifePointsGainMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, CustomVar<int> _delta)
		{
		...
		public new void Deserialize(DofusReader reader)
		{
			...
			this.Delta = reader.Read<CustomVar<int>>();
