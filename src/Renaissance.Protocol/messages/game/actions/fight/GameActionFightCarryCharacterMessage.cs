...
{
	public class GameActionFightCarryCharacterMessage : AbstractGameActionMessage, IDofusMessage
	{
		public new const int NetworkId = 5830;
		...
		public GameActionFightCarryCharacterMessage InitGameActionFightCarryCharacterMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, short _cellid)
		{
