...
{
	public class GameActionFightDodgePointLossMessage : AbstractGameActionMessage, IDofusMessage
	{
		public new const int NetworkId = 5828;
		public new int ProtocolId { get { return NetworkId; } }

		public double TargetId { get; set; }

		public CustomVar<short> Amount { get; set; }


		public GameActionFightDodgePointLossMessage() { }


		public GameActionFightDodgePointLossMessage InitGameActionFightDodgePointLossMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, CustomVar<short> _amount)
		{
		...
		public new void Deserialize(DofusReader reader)
		{
			...
			this.Amount = reader.Read<CustomVar<short>>();
