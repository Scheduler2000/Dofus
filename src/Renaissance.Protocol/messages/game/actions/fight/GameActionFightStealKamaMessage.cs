...
namespace Renaissance.Protocol.messages.game.actions.fight
{
	public class GameActionFightStealKamaMessage : AbstractGameActionMessage, IDofusMessage
	{
		...
		public GameActionFightStealKamaMessage InitGameActionFightStealKamaMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, CustomVar<long> _amount)
		{
