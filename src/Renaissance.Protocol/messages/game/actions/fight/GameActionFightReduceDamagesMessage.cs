...
namespace Renaissance.Protocol.messages.game.actions.fight
{
	public class GameActionFightReduceDamagesMessage : AbstractGameActionMessage, IDofusMessage
	{
		...
		public GameActionFightReduceDamagesMessage InitGameActionFightReduceDamagesMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, CustomVar<int> _amount)
		{
