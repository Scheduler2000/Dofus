...
namespace Renaissance.Protocol.messages.game.actions.fight
{
	public class GameActionFightDispellMessage : AbstractGameActionMessage, IDofusMessage
	{
		...
		public GameActionFightDispellMessage InitGameActionFightDispellMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, bool _verbosecast)
		{
		...
		public new Memory<byte> Serialize()
		{
			...
			size += DofusBinaryFactory.Sizing.SizeOf(VerboseCast);
			...
			writer.WriteData(this.VerboseCast);
