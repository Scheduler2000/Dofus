...
{
	public class GameActionFightModifyEffectsDurationMessage : AbstractGameActionMessage, IDofusMessage
	{
		public new const int NetworkId = 6304;
		...
		public GameActionFightModifyEffectsDurationMessage InitGameActionFightModifyEffectsDurationMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, short _delta)
		{
