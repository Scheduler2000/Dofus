...
{
	public class GameActionFightVanishMessage : AbstractGameActionMessage, IDofusMessage
	{
		public new const int NetworkId = 6217;
		...
		public GameActionFightVanishMessage InitGameActionFightVanishMessage(CustomVar<short> _actionid, double _sourceid, double _targetid)
		{
