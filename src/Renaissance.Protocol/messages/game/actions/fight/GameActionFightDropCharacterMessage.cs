...
{
	public class GameActionFightDropCharacterMessage : AbstractGameActionMessage, IDofusMessage
	{
		public new const int NetworkId = 5826;
		...
		public GameActionFightDropCharacterMessage InitGameActionFightDropCharacterMessage(CustomVar<short> _actionid, double _sourceid, double _targetid, short _cellid)
		{
