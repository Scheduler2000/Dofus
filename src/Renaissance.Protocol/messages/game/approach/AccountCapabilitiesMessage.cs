...
namespace Renaissance.Protocol.messages.game.approach
{
	public class AccountCapabilitiesMessage : IDofusMessage
	{
		...
		public  Memory<byte> Serialize()
		{
			...
			size++;
			size += DofusBinaryFactory.Sizing.SizeOf(BreedsVisible);
			size += DofusBinaryFactory.Sizing.SizeOf(BreedsAvailable);
			...
			writer.WriteData(this.BreedsVisible);
			writer.WriteData(this.BreedsAvailable);
