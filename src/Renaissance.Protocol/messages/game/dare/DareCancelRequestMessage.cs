...
{
	public class DareCancelRequestMessage : IDofusMessage
	{
		public  const int NetworkId = 6680;
		...
		public DareCancelRequestMessage InitDareCancelRequestMessage(double _dareid)
		{
