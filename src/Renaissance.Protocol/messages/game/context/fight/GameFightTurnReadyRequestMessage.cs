...
{
	public class GameFightTurnReadyRequestMessage : IDofusMessage
	{
		public  const int NetworkId = 715;
		...
		public GameFightTurnReadyRequestMessage InitGameFightTurnReadyRequestMessage(double _id)
		{
