...
{
	public class PartyInvitationDungeonRequestMessage : PartyInvitationRequestMessage, IDofusMessage
	{
		public new const int NetworkId = 6245;
		...
		public PartyInvitationDungeonRequestMessage InitPartyInvitationDungeonRequestMessage(CustomVar<short> _dungeonid)
		{
