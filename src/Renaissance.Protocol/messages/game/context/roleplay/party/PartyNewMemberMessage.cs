...
{
	public class PartyNewMemberMessage : PartyUpdateMessage, IDofusMessage
	{
		public new const int NetworkId = 6306;
		...
		public PartyNewMemberMessage InitPartyNewMemberMessage()
		{
