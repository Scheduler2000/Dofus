...
{
	public class DungeonPartyFinderListenErrorMessage : IDofusMessage
	{
		public  const int NetworkId = 6248;
		...
		public DungeonPartyFinderListenErrorMessage InitDungeonPartyFinderListenErrorMessage(CustomVar<short> _dungeonid)
		{
