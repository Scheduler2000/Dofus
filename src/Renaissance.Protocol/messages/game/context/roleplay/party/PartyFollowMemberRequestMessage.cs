...
{
	public class PartyFollowMemberRequestMessage : AbstractPartyMessage, IDofusMessage
	{
		public new const int NetworkId = 5577;
		...
		public PartyFollowMemberRequestMessage InitPartyFollowMemberRequestMessage(CustomVar<int> _partyid, CustomVar<long> _playerid)
		{
