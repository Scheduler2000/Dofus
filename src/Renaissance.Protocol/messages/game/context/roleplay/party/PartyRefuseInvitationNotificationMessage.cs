...
{
	public class PartyRefuseInvitationNotificationMessage : AbstractPartyEventMessage, IDofusMessage
	{
		public new const int NetworkId = 5596;
		...
		public PartyRefuseInvitationNotificationMessage InitPartyRefuseInvitationNotificationMessage(CustomVar<int> _partyid, CustomVar<long> _guestid)
		{
