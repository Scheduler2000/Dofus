...
{
	public class JobCrafterDirectoryEntryRequestMessage : IDofusMessage
	{
		public  const int NetworkId = 6043;
		...
		public JobCrafterDirectoryEntryRequestMessage InitJobCrafterDirectoryEntryRequestMessage(CustomVar<long> _playerid)
		{
