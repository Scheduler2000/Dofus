...
{
	public class QuestStepInfoRequestMessage : IDofusMessage
	{
		public  const int NetworkId = 5622;
		...
		public QuestStepInfoRequestMessage InitQuestStepInfoRequestMessage(CustomVar<short> _questid)
		{
