...
{
	public class QuestStartedMessage : IDofusMessage
	{
		public  const int NetworkId = 6091;
		...
		public QuestStartedMessage InitQuestStartedMessage(CustomVar<short> _questid)
		{
