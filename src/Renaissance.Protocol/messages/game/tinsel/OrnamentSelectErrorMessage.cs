...
{
	public class OrnamentSelectErrorMessage : IDofusMessage
	{
		public  const int NetworkId = 6370;
		...
		public OrnamentSelectErrorMessage InitOrnamentSelectErrorMessage(byte _reason)
		{
