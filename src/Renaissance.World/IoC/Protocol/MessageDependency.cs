...
namespace Renaissance.World.IoC.Protocol
{
    public class MessageDependency
    {
        private readonly ImmutableDictionary<int, Func<IDofusMessage>>.Builder m_messages;
        ...
        public MessageDependency Congifure()
        {
            ...
            Logger.Instance.Log(LogLevel.Debug, "WORLD PROTOCOL", $"{ types.Count()} entities loaded.");
