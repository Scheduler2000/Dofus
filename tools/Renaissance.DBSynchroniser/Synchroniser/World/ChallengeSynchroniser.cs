...
{
    public class ChallengeSynchroniser : AbstractSynchroniser<Challenge, ChallengeData>
    {
        private readonly D2IManager m_d2i;


        public ChallengeSynchroniser(D2IManager d2i, IEnumerable<ChallengeData> datas, IRepository<Challenge> database)
            : base(datas, database) { this.m_d2i = d2i; }


        protected override Challenge BuildEntity(ChallengeData data)
        {
